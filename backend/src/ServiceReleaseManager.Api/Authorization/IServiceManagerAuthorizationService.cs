...
{
  public Task<bool> EvaluateOrganisationAuthorization(
  ...
  public Task<bool> EvaluateOrganisationAuthorizationServiceId(
    ClaimsPrincipal claimsPrincipal,
    int serviceId,
    OrganisationAuthorizationRequirement requirement,
    CancellationToken cancellationToken
  ...
  public Task<bool> EvaluateServiceAuthorization(
    ClaimsPrincipal claimsPrincipal,
    int serviceId,
