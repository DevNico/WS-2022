...
{
  public Task<bool> EvaluateOrganisationAuthorization(ClaimsPrincipal claimsPrincipal,
  ...
  public Task<bool> EvaluateOrganisationAuthorizationServiceId(ClaimsPrincipal claimsPrincipal,
    int serviceId,
    OrganisationAuthorizationRequirement requirement, CancellationToken cancellationToken);

  public Task<bool> EvaluateOrganisationAuthorizationServiceRouteName(
  ...
  public Task<bool> EvaluateServiceAuthorization(ClaimsPrincipal claimsPrincipal,
