...
public interface IGitHubProxy
{
  ...
  Task<Result<IEnumerable<GitHubPullRequest>>> ListPulls(
    string owner,
    string repo,
  ...
  /// <exception cref="ArgumentOutOfRangeException">Thrown if the limit is not between 1 and 100</exception>
  Task<Result<IEnumerable<GitHubIssue>>> ListIssues(
    string owner,
    string repo,
    CancellationToken ct,
    int limit = 100
  ...
  /// <exception cref="ArgumentOutOfRangeException">Thrown if the limit is not between 1 and 100</exception>
  Task<Result<IEnumerable<GitHubCommit>>> ListCommits(
    string owner,
    string repo,
    CancellationToken ct,
  ...
  /// <returns>A list of <see cref="GitHubIssue" /> wrapped in a <see cref="Result{T}" /> object</returns>
  /// <exception cref="ArgumentOutOfRangeException">Thrown if the limit is not between 1 and 100</exception>
  Task<Result<IEnumerable<GitHubIssue>>> ListIssuesClosedAfter(
    string owner,
    string repo,
    DateTime timestamp,
    CancellationToken ct,
  ...
  /// <returns>A list of <see cref="GitHubPullRequest" /> wrapped in a <see cref="Result{T}" /> object</returns>
  /// <exception cref="ArgumentOutOfRangeException">Thrown if the limit is not between 1 and 100</exception>
  Task<Result<IEnumerable<GitHubPullRequest>>> ListPullsMergedAfter(
    string owner,
    string repo,
    DateTime timestamp,
    CancellationToken ct,
  ...
  /// <returns>A list of <see cref="GitHubCommit" /> wrapped in a <see cref="Result{T}" /> object</returns>
  /// <exception cref="ArgumentOutOfRangeException">Thrown if the limit is not between 1 and 100</exception>
  Task<Result<IEnumerable<GitHubCommit>>> ListCommitsAfter(
    string owner,
    string repo,
    DateTime timestamp,
    CancellationToken ct,
