...
public class ServiceServiceTest
{
  ...
  public ServiceServiceTest()
  {
    ...
    _serviceTemplate =
      new ServiceTemplate("Template", "{}", "{}", 0) { Organisation = _organisation };
  ...
  public async Task CreateShould()
  {
    ...
    _repositoryMock.Setup(m => m.AddAsync(It.IsAny<Service>(), It.IsAny<CancellationToken>()))
                   .ReturnsAsync(service);
    _serviceTemplateRepositoryMock
     .Setup(
        r => r.GetBySpecAsync(It.IsAny<ServiceTemplateByIdSpec>(), It.IsAny<CancellationToken>())
      ).ReturnsAsync(_serviceTemplate);
    _organisationRepositoryMock
     .Setup(r => r.GetBySpecAsync(It.IsAny<OrganisationByIdSpec>(), It.IsAny<CancellationToken>()))
     .ReturnsAsync(_organisation);

    var serviceService = new ServiceService(
      _repositoryMock.Object,
      _serviceTemplateRepositoryMock.Object
    );
    var result = await serviceService.Create(
      service.Name,
      service.Description,
  ...
  public async Task DeleteShould()
  {
    ...
    _repositoryMock
     .Setup(m => m.GetBySpecAsync(It.IsAny<ServiceByIdSpec>(), It.IsAny<CancellationToken>()))
     .ReturnsAsync(_service0);
  ...
  public async Task GetByRouteNameShould()
  {
    ...
    _repositoryMock
     .Setup(
        m => m.GetBySpecAsync(It.IsAny<ServiceByRouteNameSpec>(), It.IsAny<CancellationToken>())
      ).ReturnsAsync(_service0);
    ...
    _repositoryMock.Verify(
      m => m.GetBySpecAsync(
        It.IsAny<ServiceByRouteNameSpec>(),
        It.Is<CancellationToken>(c => c == cancellationToken)
      ),
      Times.Once
    );
  ...
  public async Task GetByNameAndOrganisationIdShould()
  {
    ...
    _repositoryMock
     .Setup(
        m => m.GetBySpecAsync(
          It.IsAny<ServiceByNameAndOrganisationIdSpec>(),
          It.IsAny<CancellationToken>()
        )
      ).ReturnsAsync(_service0);

    var result = await serviceService.GetByNameAndOrganisationId(
      _service0.Name,
      _organisation.Id,
      cancellationToken
    );
  ...
  public async Task GetByOrganisationUserIdShould()
  {
    ...
    _repositoryMock
     .Setup(
        m => m.ListAsync(
          It.IsAny<ServicesByOrganisationUserIdSpec>(),
          It.IsAny<CancellationToken>()
        )
      ).ReturnsAsync(new List<Service> { _service0 });
  ...
  public async Task ServiceTemplateShould()
  {
    ...
    _serviceTemplateRepositoryMock
     .Setup(
        m => m.GetBySpecAsync(It.IsAny<ServiceTemplateByIdSpec>(), It.IsAny<CancellationToken>())
      ).ReturnsAsync(_serviceTemplate);
    ...
    _serviceTemplateRepositoryMock.Verify(
      m => m.GetBySpecAsync(
        It.IsAny<ServiceTemplateByIdSpec>(),
        It.Is<CancellationToken>(c => c == cancellationToken)
      ),
      Times.Once
    );
